...
Flux Fidelity does not request cookie, browsing-history, web-request, download, clipboard, notification, or background network-access permissions. Websites and the browser may perform their own network activity independently of the extension.
